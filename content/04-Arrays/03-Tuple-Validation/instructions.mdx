...
In such cases, you can use the `prefixItems` [keyword](https://json-schema.org/learn/glossary#keyword) to define the schema for each element of the tuple array.
