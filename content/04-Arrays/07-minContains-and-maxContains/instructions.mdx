...
However, there are scenarios where we need to ensure that an array contains a specific number of elements that match a [subschema](https://json-schema.org/learn/glossary#subschema).
