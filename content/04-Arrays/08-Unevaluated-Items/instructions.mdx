...
Consider, we have defined array items with `prefixItems`. When you have items more than the defined `prefixItems`, you can use `unevaluatedItems` to define a *subschema* for the remaining items.
