...
Now, add the `minLength` and `maxLength` constraints to the `postalCode` and `phoneNumber` fields in the right-side editor while keeping these constraints in mind.
