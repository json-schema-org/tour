...
Previously, we have used enumerated values only for strings. But you can also use enumerated values for numbers and null values.
...
Now, try to modify the `performanceRating` property on the right side editor to accept only the values `1`, `2`, `3`, `4`, `5`, and `null`.