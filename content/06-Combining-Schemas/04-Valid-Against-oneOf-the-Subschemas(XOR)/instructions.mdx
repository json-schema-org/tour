...
When you want to ensure that an [_instance_](https://json-schema.org/learn/glossary#instance) is valid against **exactly one of** the [subschemas](https://json-schema.org/learn/glossary#subschema), you can use the `oneOf` [keyword](https://json-schema.org/learn/glossary#keyword).

You can think of `oneOf` as an **XOR operation** between subschemas. If more than one subschema is valid, the [_instance_](https://json-schema.org/learn/glossary#instance) is considered invalid.
