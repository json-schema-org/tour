...
`anyOf` keyword is used to define multiple [subschemas](https://json-schema.org/learn/glossary#subschema). If the [_instance_](https://json-schema.org/learn/glossary#instance) is valid against **any one** of the [subschemas](https://json-schema.org/learn/glossary#subschema), the document is considered valid.

You can think of `anyOf` as an **OR** operation. If the [_instance_](https://json-schema.org/learn/glossary#instance) is valid against **any one** of the [subschemas](https://json-schema.org/learn/glossary#subschema), the document is considered valid.
