...
When you want to ensure that an [_instance_](https://json-schema.org/learn/glossary#instance) is valid against **all of** the [subschemas](https://json-schema.org/learn/glossary#subschema), you can use the `allOf` [keyword](https://json-schema.org/learn/glossary#keyword). 

You can think of `allOf` as an **AND operation** between subschemas. if one of the subschemas fails, the [_instance_](https://json-schema.org/learn/glossary#instance) is considered invalid.
