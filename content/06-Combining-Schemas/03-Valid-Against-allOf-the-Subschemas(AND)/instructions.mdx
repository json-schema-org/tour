...
When you want to ensure that an [_instance_](https://json-schema.org/learn/glossary#instance) is valid against **all of** the subschemas, you can use the `allOf` keyword. 
