...
`not` keyword is used to invert the validation. If the [_instance_](https://json-schema.org/learn/glossary#instance) is **not** valid against the subschema, the document is considered valid.
