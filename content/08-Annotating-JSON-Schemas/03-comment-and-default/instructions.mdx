...
To add comments in  your JSON Schema, use the `$comment` [keyword](https://json-schema.org/learn/glossary#subschema). The `$comment` keyword is a **string** that provides additional information about the schema. 
