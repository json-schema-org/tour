...
The `deprecated` [keyword](https://json-schema.org/learn/glossary#subschema) is a **boolean** that indicates that the [_instance_](https://json-schema.org/learn/glossary#instance) value the keyword applies to **should not be used and may be removed in the future**.
