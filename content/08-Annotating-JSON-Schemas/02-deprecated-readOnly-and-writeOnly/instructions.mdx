...
The `deprecated` [keyword](https://json-schema.org/learn/glossary#subschema) is a **boolean** that indicates that the [instance](https://json-schema.org/learn/glossary#instance) value the keyword applies to **should not be used and may be removed in the future**.
...
In the above example, the [schema](https://json-schema.org/learn/glossary#schema) is marked as deprecated. This means that the schema should not be used.
