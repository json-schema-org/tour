...
In *JSON Schema*, you can apply schema to property names using the `propertyNames` [keyword](https://json-schema.org/learn/glossary#keyword). This keyword allows you to define a schema that restricts the property names of an object.
