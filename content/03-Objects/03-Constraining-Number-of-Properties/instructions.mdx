...
Now, add the `minProperties` and `maxProperties` keywords to the [schema](https://json-schema.org/learn/glossary#schema) on the <SideEditorLink/> to set the minimum and maximum number of properties in the `contactMethods` object.
