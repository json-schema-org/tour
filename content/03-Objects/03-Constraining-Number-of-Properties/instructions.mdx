...
Additionally, in the `contactMethods` object, use the `additionalProperties` [keyword](https://json-schema.org/learn/glossary#keyword) to ensure that the values of the properties are `string` type.